...
function SystemDesign() {
  ...
  return (
    <>
      ...
      <div>
        <h2>System Design Interview Guide</h2>
        <ul>
          <li className="pb-2">
            <div className="pb-2">Tips:</div>
            <ul className="pb-2">
              <li>Make sure you walk through every API call after your design</li>
              <li>If you’re going to make any elegant drawings at all, make sure you’re fluent in your design software</li>
              <li>Do not blurt out SQL vs NoSQL pros & cons. Only mention whatever is directly relevant to your problem</li>
              <li>Be very wary of time</li>
              <li>A lot of major parts in the SD interview can be covered in under 20 seconds, so don’t spend 5 minutes on them</li>
              <li>I.e. Edge cases, bottlenecks, analytics, security, health checks</li>
              <li>The interviewer will ask for more detail if they want you to spend more time</li>
              <li>When making modifications due to changing requirements at the end of the interview, you don’t have to draw them</li>
              <li>Requirements and Math mostly the same in every SD interview, don’t spend much time here</li>
            </ul>
          </li>
          <li className="pb-2">
            ...
            <ul className="pb-2">
              ...
              <li>Back of the envelope estimations
                <ul>
              ...
              <ul>
                <li>User: UserID, Name, Email, DoB, CreationDate, LastLogin, etc.</li>
              ...
              <ul>
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <li>Photo has own primary id, int serial, has user id as foreign key</li>
                  </ul>
                  <li>NoSQL better for unorganized data, easier to horizontally scale & shard</li>
                </ul>
              </ul>
          ...
          <li className="pb-2">
            ...
            <ul className="pb-2">
              <li>AI driven System Design interview https://www.hellointerview.com/</li>
            </ul>
          </li>
        </ul>
      </div>
