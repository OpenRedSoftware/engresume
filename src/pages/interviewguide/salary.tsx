            ...
            <ul className="pb-2">
              ...
              <ul>
                ...
                <ul>
                  ...
                  <li>
                    In over 1,000 candidate hires, we've seen only 2 or 3 cases
                    of an offer being withdrawn due to negotiation.
                  </li>
                </ul>
              </ul>
            </ul>
          ...
          <li>
            ...
            <ul className="pb-2">
              ...
              <ul>
                ...
                <li>
                  The highest salary you can get is the top of the pay band for
                  this role.
                </li>
                <li>
              ...
              <ul>
                <li>
                  Don't bring up your current comp unless you have to. Focus on
                  what comp you would like to see.
                </li>
              </ul>
              <li>
              ...
              <ul>
                ...
                <li>
                  If you won't quit your current job for anything less than
                  180k, don’t say “160-200” and hope it will somehow work out.
                  Say “180-200”, and be ready to accept 180.
                </li>
                <li>
